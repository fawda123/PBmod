...
6. Add depth to to `lxly.inp`.  This is done in R by combining the cvl grid shapefile and manually created bathymetry raster. The empty depht column in `lxly.inp` is replaced with the average depth in each grid cell (L).
